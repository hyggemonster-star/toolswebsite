...
const PptPdfToolRenderer = dynamic(() => import("./tools/PptPdfToolRenderer").then((module) => module.PptPdfToolRenderer));
...
export function ToolRenderer({ tool }: { tool: ToolRecord }) {
  switch (tool.slug) {
    ...
    case "ppt-to-pdf": return <PptPdfToolRenderer tool={tool} />;
