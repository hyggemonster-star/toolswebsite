...
const comparisonConfigs: Record<ComparisonTrack, { title: string; description: string; categories: AiDirectoryCategory[]; note: string }> = {
  writing: { title: "写作工具对比", description: "按长文、研究、表达整理和知识协作场景筛选官方入口。", categories: ["writing", "general", "research", "workspace"], note: "写作工具的优势取决于素材、事实核对和编辑流程，本页不提供生成质量排名。" },
  image: { title: "图片创作工具对比", description: "按视觉探索、社媒设计和通用多模态场景筛选官方入口。", categories: ["image", "general", "workspace"], note: "图片工具的版权、商用和输出限制可能变化，使用前请核对官方规则。" },
  video: { title: "视频创作工具对比", description: "把视频创作拆成概念、脚本、视觉和生成环节，选择适合当前任务的入口。", categories: ["video", "image", "writing", "general"], note: "视频创作通常需要多个环节协作，本页按工作流角色对照，不把单一工具包装成全能方案。" },
  coding: { title: "编程效率工具对比", description: "按代码补全、项目理解、问题拆解和协作场景筛选官方入口。", categories: ["coding", "general", "writing", "research"], note: "编程助手不能替代代码审查、测试、权限控制和安全评估。" },
};
