...
const toolSeeds: ToolSeed[] = [
  ...
  { id: 53, name: "小红书标签推荐", slug: "xhs-hashtag-recommender", category: "creator", subCategory: "小红书", description: "在浏览器本地根据主题词整理可供人工筛选的标签方向。", priority: 3, tags: ["小红书", "标签", "运营"], isClientSide: true, riskLevel: "low" },
  ...
  { id: 72, name: "小红书 Prompt 模板库", slug: "xhs-prompt-library", category: "ai", subCategory: "Prompt 模板", description: "在浏览器本地按选题、标题、笔记和互动场景整理可填充、可复制的 Prompt 模板，不读取实时平台数据。", priority: 3, tags: ["Prompt", "小红书", "内容运营"], isClientSide: true, riskLevel: "low" },
  { id: 73, name: "电商 Prompt 模板库", slug: "ecommerce-prompt-library", category: "ai", subCategory: "Prompt 模板", description: "在浏览器本地按商品、营销、客服和跨境场景整理可填充、可复制的 Prompt 模板，不读取实时平台数据。", priority: 3, tags: ["Prompt", "电商", "运营"], isClientSide: true, riskLevel: "low" },
  { id: 74, name: "短视频 Prompt 模板库", slug: "short-video-prompt-library", category: "ai", subCategory: "Prompt 模板", description: "在浏览器本地按选题、脚本、分镜和复盘场景整理可填充、可复制的 Prompt 模板，不读取实时平台数据。", priority: 3, tags: ["Prompt", "短视频", "内容运营"], isClientSide: true, riskLevel: "low" },
  { id: 75, name: "文本表达整理", slug: "ai-rewrite", category: "ai", subCategory: "文本处理", description: "在浏览器本地清理段落格式、检查口语化表达和长句，不承诺改写、降重或规避检测。", priority: 3, tags: ["文本", "表达", "办公"], isClientSide: true, riskLevel: "low" },
  { id: 76, name: "长文重点整理", slug: "ai-long-summary", category: "ai", subCategory: "文本处理", description: "在浏览器本地从文章或会议记录中提取标题线索、重点段落和行动项，不调用 AI。", priority: 3, tags: ["长文", "重点", "办公"], isClientSide: true, riskLevel: "low" },
  { id: 77, name: "工作周报整理", slug: "ai-weekly-report", category: "ai", subCategory: "办公效率", description: "在浏览器本地根据本周记录和下周计划整理可继续编辑的周报草稿，不调用 AI。", priority: 3, tags: ["周报", "办公", "项目管理"], isClientSide: true, riskLevel: "low" },
  { id: 78, name: "简历内容整理", slug: "ai-resume", category: "ai", subCategory: "求职", description: "在浏览器本地根据目标岗位和真实经历整理可继续编辑的简历内容，不调用 AI。", priority: 3, tags: ["简历", "求职", "办公"], isClientSide: true, riskLevel: "low" },
  { id: 79, name: "面试准备整理", slug: "ai-interview-questions", category: "ai", subCategory: "求职", description: "在浏览器本地根据目标岗位、面试阶段和真实经历整理练习方向与追问清单，不调用 AI。", priority: 3, tags: ["面试", "求职", "办公"], isClientSide: true, riskLevel: "low" },
