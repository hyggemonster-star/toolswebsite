...
const toolSeeds: ToolSeed[] = [
  ...
  { id: 2, name: "Word 转 PDF", slug: "word-to-pdf", category: "pdf-office", subCategory: "文档转换", description: "在浏览器本地提取 DOCX 正文文字，排版生成适合阅读、打印和分享的基础 PDF；原 Word 版式不会完整保留。", priority: 3, tags: ["Word", "DOCX", "PDF", "转换"], isClientSide: true, riskLevel: "medium" },
  ...
  { id: 5, name: "PDF 拆分", slug: "pdf-split", category: "pdf-office", subCategory: "PDF 处理", description: "按页码范围拆出需要的 PDF 页面。", priority: 3, tags: ["PDF", "拆分", "页面"], isClientSide: true, riskLevel: "medium" },
  { id: 6, name: "PDF 转图片", slug: "pdf-to-image", category: "pdf-office", subCategory: "文档转换", description: "在浏览器本地把 PDF 页面渲染为 PNG 或 JPG，适合预览和分享。", priority: 3, tags: ["PDF", "图片", "导出"], isClientSide: true, riskLevel: "medium" },
  { id: 7, name: "图片转 PDF", slug: "image-to-pdf", category: "pdf-office", subCategory: "文档转换", description: "将多张图片整理成一份 PDF 文档。", priority: 3, tags: ["图片", "PDF", "转换"], isClientSide: true, riskLevel: "medium" },
  { id: 8, name: "PDF 加水印", slug: "pdf-watermark", category: "pdf-office", subCategory: "PDF 处理", description: "为 PDF 页面添加文字水印或版权提示。", priority: 4, tags: ["PDF", "水印", "版权"], isClientSide: true, riskLevel: "medium" },
  ...
  { id: 10, name: "PDF 解密（限已知密码）", slug: "pdf-decrypt", category: "pdf-office", subCategory: "隐私保护", description: "输入你已知的打开密码，在浏览器本地重新导出一份无密码 PDF；只处理你拥有权限的文件。", priority: 4, tags: ["PDF", "解密", "授权"], isClientSide: true, riskLevel: "high" },
  { id: 11, name: "PDF 页面旋转", slug: "pdf-rotate", category: "pdf-office", subCategory: "页面编辑", description: "调整 PDF 单页或多页的方向。", priority: 4, tags: ["PDF", "旋转", "页面"], isClientSide: true, riskLevel: "medium" },
  { id: 12, name: "PDF 删除页面", slug: "pdf-delete-pages", category: "pdf-office", subCategory: "页面编辑", description: "从 PDF 中移除不需要的页面。", priority: 4, tags: ["PDF", "删除", "页面"], isClientSide: true, riskLevel: "medium" },
  { id: 13, name: "PDF 页面重新排序", slug: "pdf-reorder-pages", category: "pdf-office", subCategory: "页面编辑", description: "拖动调整 PDF 页面排列顺序。", priority: 4, tags: ["PDF", "排序", "页面"], isClientSide: true, riskLevel: "medium" },
  ...
  { id: 18, name: "PPT 转 PDF", slug: "ppt-to-pdf", category: "pdf-office", subCategory: "文档转换", description: "在浏览器本地提取 PPTX 幻灯片文字，按页排版生成适合阅读、打印和分享的基础 PDF；复杂 PowerPoint 版式不会完整保留。", priority: 4, tags: ["PPT", "PPTX", "PDF", "转换"], isClientSide: true, riskLevel: "medium" },
  ...
  { id: 22, name: "图片格式转换", slug: "image-convert", category: "image", subCategory: "格式转换", description: "在 JPG、PNG、WEBP 等常见图片格式之间转换。", priority: 3, tags: ["图片", "格式", "转换"], isClientSide: true, riskLevel: "low" },
  ...
  { id: 25, name: "图片裁剪", slug: "image-crop", category: "image", subCategory: "图片编辑", description: "裁剪图片比例和画布范围，适配不同平台。", priority: 3, tags: ["图片", "裁剪", "比例"], isClientSide: true, riskLevel: "low" },
  { id: 26, name: "图片去背景", slug: "image-background-remove", category: "image", subCategory: "图片编辑", description: "在浏览器本地按角落取样移除相连的纯色背景，生成透明 PNG。", priority: 3, tags: ["图片", "去背景", "纯色背景"], isClientSide: true, riskLevel: "medium" },
  { id: 27, name: "图片加水印", slug: "image-watermark", category: "image", subCategory: "版权保护", description: "为图片添加文字水印，保护内容署名。", priority: 3, tags: ["图片", "水印", "版权"], isClientSide: true, riskLevel: "low" },
  { id: 28, name: "图片批量加水印", slug: "image-batch-watermark", category: "image", subCategory: "版权保护", description: "一次为多张图片添加统一水印。", priority: 4, tags: ["图片", "批量", "水印"], isClientSide: true, riskLevel: "low" },
  { id: 29, name: "图片去 EXIF 隐私信息", slug: "image-remove-exif", category: "image", subCategory: "隐私保护", description: "移除图片中的拍摄设备和定位等 EXIF 信息。", priority: 3, tags: ["图片", "EXIF", "隐私"], isClientSide: true, riskLevel: "low" },
  { id: 30, name: "图片转 Base64", slug: "image-to-base64", category: "image", subCategory: "开发辅助", description: "将图片转换为可嵌入网页的 Base64 数据。", priority: 4, tags: ["图片", "Base64", "开发"], isClientSide: true, riskLevel: "low" },
  { id: 31, name: "Base64 转图片", slug: "base64-to-image", category: "image", subCategory: "开发辅助", description: "将 Base64 数据还原为可下载的图片文件。", priority: 4, tags: ["Base64", "图片", "开发"], isClientSide: true, riskLevel: "low" },
  { id: 32, name: "图片转 ICO 图标", slug: "image-to-ico", category: "image", subCategory: "开发辅助", description: "制作网站 favicon 和桌面图标文件。", priority: 4, tags: ["图片", "ICO", "图标"], isClientSide: true, riskLevel: "low" },
  ...
  { id: 44, name: "视频格式转换", slug: "video-convert", category: "video-audio", subCategory: "格式转换", description: "将浏览器能播放的视频重新编码为 WebM，适合网页播放和轻量分享；当前不保证任意格式互转。", priority: 4, tags: ["视频", "WebM", "转换"], isClientSide: true, riskLevel: "medium" },
  { id: 45, name: "音频格式转换", slug: "audio-convert", category: "video-audio", subCategory: "格式转换", description: "将浏览器能解码的音频转换为标准 16-bit PCM WAV；当前不保证 MP3、AAC、OGG 等任意格式互转。", priority: 4, tags: ["音频", "WAV", "转换"], isClientSide: true, riskLevel: "medium" },
  { id: 46, name: "音频压缩", slug: "audio-compress", category: "video-audio", subCategory: "音频优化", description: "在浏览器本地按目标码率重新编码 OGG/WebM 音频；不保证 MP3/WAV 格式或体积一定更小。", priority: 4, tags: ["音频", "压缩", "文件"], isClientSide: true, riskLevel: "medium" },
  ...
  // 自媒体运营工具
  { id: 51, name: "小红书标题生成器", slug: "xhs-title-generator", category: "creator", subCategory: "小红书", description: "调用 AI 根据主题、场景和语气生成可继续修改的小红书标题。", priority: 3, tags: ["小红书", "标题", "创作"], isClientSide: false, riskLevel: "low" },
  { id: 52, name: "小红书笔记优化", slug: "xhs-note-formatter", category: "creator", subCategory: "小红书", description: "调用 AI 在保留真实信息的前提下整理笔记结构、段落和表达。", priority: 3, tags: ["小红书", "排版", "笔记"], isClientSide: false, riskLevel: "low" },
  { id: 53, name: "小红书标签推荐", slug: "xhs-hashtag-recommender", category: "creator", subCategory: "小红书", description: "调用 AI 根据主题、场景和受众生成标签方向，不读取平台热度数据。", priority: 3, tags: ["小红书", "标签", "运营"], isClientSide: false, riskLevel: "low" },
  ...
  { id: 56, name: "小红书标题结构分析", slug: "xhs-title-analyzer", category: "creator", subCategory: "内容分析", description: "调用 AI 拆解标题结构并给出保持事实不变的修改建议，不预测流量。", priority: 3, tags: ["小红书", "标题", "结构"], isClientSide: false, riskLevel: "low" },
  { id: 57, name: "抖音标题生成器", slug: "douyin-title-generator", category: "creator", subCategory: "抖音", description: "调用 AI 根据视频主题、场景和语气生成标题方向，不读取平台数据。", priority: 3, tags: ["抖音", "标题", "创作"], isClientSide: false, riskLevel: "low" },
  { id: 58, name: "抖音口播脚本生成", slug: "douyin-script-generator", category: "creator", subCategory: "抖音", description: "调用 AI 生成包含开场、核心内容和画面提示的短视频口播稿。", priority: 3, tags: ["抖音", "脚本", "口播"], isClientSide: false, riskLevel: "low" },
  { id: 59, name: "短视频分镜脚本生成", slug: "short-video-storyboard", category: "creator", subCategory: "短视频", description: "调用 AI 根据主题、场景和时长生成可执行的短视频分镜。", priority: 3, tags: ["短视频", "分镜", "脚本"], isClientSide: false, riskLevel: "low" },
  ...
  { id: 62, name: "公众号标题生成器", slug: "wechat-title-generator", category: "creator", subCategory: "公众号", description: "调用 AI 根据文章主题、方向和语气生成公众号标题方向。", priority: 3, tags: ["公众号", "标题", "创作"], isClientSide: false, riskLevel: "low" },
  ...
  { id: 64, name: "微信朋友圈文案生成", slug: "moments-copy-generator", category: "creator", subCategory: "朋友圈", description: "调用 AI 把真实经历整理成自然、克制的朋友圈文案方向。", priority: 4, tags: ["朋友圈", "文案", "创作"], isClientSide: false, riskLevel: "low" },
  { id: 65, name: "评论区回复生成器", slug: "comment-reply-generator", category: "creator", subCategory: "互动运营", description: "调用 AI 根据评论上下文生成礼貌、自然、可编辑的回复。", priority: 4, tags: ["评论", "回复", "运营"], isClientSide: false, riskLevel: "low" },
  ...
  { id: 67, name: "AI 写作工具对比", slug: "ai-writing-comparison", category: "ai", subCategory: "工具对比", description: "基于人工维护的官方入口和使用场景，筛选 AI 写作、研究与整理工具；不读取实时价格或排名。", priority: 4, tags: ["AI", "写作", "对比"], isClientSide: true, riskLevel: "low" },
  { id: 68, name: "AI 图片工具对比", slug: "ai-image-comparison", category: "ai", subCategory: "工具对比", description: "基于人工维护的官方入口和使用场景，筛选 AI 图片与设计工具；不读取实时价格或排名。", priority: 4, tags: ["AI", "图片", "对比"], isClientSide: true, riskLevel: "low" },
  { id: 69, name: "AI 视频工具对比", slug: "ai-video-comparison", category: "ai", subCategory: "工具对比", description: "按视频概念、脚本、视觉和生成环节筛选 AI 工具官方入口；不读取实时价格或排名。", priority: 4, tags: ["AI", "视频", "对比"], isClientSide: true, riskLevel: "low" },
  { id: 70, name: "AI 编程工具对比", slug: "ai-coding-comparison", category: "ai", subCategory: "工具对比", description: "按代码补全、项目理解与开发协作场景筛选 AI 工具官方入口；不读取实时价格或排名。", priority: 4, tags: ["AI", "编程", "对比"], isClientSide: true, riskLevel: "low" },
  { id: 71, name: "Prompt 生成器", slug: "prompt-generator", category: "ai", subCategory: "Prompt", description: "调用 AI 把目标、受众和要求整理成可直接使用的 Prompt。", priority: 2, tags: ["AI", "Prompt", "提示词"], isClientSide: false, riskLevel: "low" },
  { id: 72, name: "小红书 Prompt 模板库", slug: "xhs-prompt-library", category: "ai", subCategory: "Prompt 模板", description: "调用 AI 按小红书创作场景生成可复用的 Prompt，不读取实时平台数据。", priority: 3, tags: ["Prompt", "小红书", "内容运营"], isClientSide: false, riskLevel: "low" },
  { id: 73, name: "电商 Prompt 模板库", slug: "ecommerce-prompt-library", category: "ai", subCategory: "Prompt 模板", description: "调用 AI 根据真实商品信息生成电商标题、卖点、详情页或客服内容。", priority: 3, tags: ["Prompt", "电商", "运营"], isClientSide: false, riskLevel: "low" },
  { id: 74, name: "短视频 Prompt 模板库", slug: "short-video-prompt-library", category: "ai", subCategory: "Prompt 模板", description: "调用 AI 按短视频选题、脚本、分镜或复盘场景生成可复用 Prompt。", priority: 3, tags: ["Prompt", "短视频", "内容运营"], isClientSide: false, riskLevel: "low" },
  { id: 75, name: "文本表达整理", slug: "ai-rewrite", category: "ai", subCategory: "文本处理", description: "调用 AI 在不改变事实和原意的前提下改善文字表达。", priority: 3, tags: ["文本", "表达", "办公"], isClientSide: false, riskLevel: "low" },
  { id: 76, name: "长文重点整理", slug: "ai-long-summary", category: "ai", subCategory: "文本处理", description: "调用 AI 从文章或会议记录中整理核心结论、关键事实和行动项。", priority: 3, tags: ["长文", "重点", "办公"], isClientSide: false, riskLevel: "low" },
  { id: 77, name: "工作周报整理", slug: "ai-weekly-report", category: "ai", subCategory: "办公效率", description: "调用 AI 把完成事项、问题风险和下周计划整理成可编辑周报。", priority: 3, tags: ["周报", "办公", "项目管理"], isClientSide: false, riskLevel: "low" },
  { id: 78, name: "简历内容整理", slug: "ai-resume", category: "ai", subCategory: "求职", description: "调用 AI 根据真实经历和目标岗位优化简历内容，缺少证据时标记补充。", priority: 3, tags: ["简历", "求职", "办公"], isClientSide: false, riskLevel: "low" },
  { id: 79, name: "面试准备整理", slug: "ai-interview-questions", category: "ai", subCategory: "求职", description: "调用 AI 根据目标岗位和真实经历整理面试问题与回答思路。", priority: 3, tags: ["面试", "求职", "办公"], isClientSide: false, riskLevel: "low" },
  { id: 80, name: "PPT 大纲整理", slug: "ai-ppt-outline", category: "ai", subCategory: "办公效率", description: "调用 AI 根据主题、受众和目标生成可继续制作的演示大纲。", priority: 3, tags: ["PPT", "大纲", "办公"], isClientSide: false, riskLevel: "low" },
